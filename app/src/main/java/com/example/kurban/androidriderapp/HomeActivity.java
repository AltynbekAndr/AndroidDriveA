...
public class HomeActivity extends AppCompatActivity
    ...
    private static final int MY_PERMISSION_REQUEST_CODE = 1503;
    private static final int PLAY_SERVICES_RES_REQUEST = 1504;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentManager.beginTransaction().replace(R.id.myframe,blankFragment).commit();
        setUpLocation();
